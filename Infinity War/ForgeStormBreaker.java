 ...
 * Create and populate a 2D array with r rows and c columns with
 * ForgeStormbreakerInputFile
 * data.
 * 
 * Step 2:
 * ForgeStormbreakerOutputFile name is passed through the command line as
 * args[1]
 * Given the 2D array where the values are the flux intensity data of the
 ...
 * 3. java -cp bin avengers/ForgeStormBreaker forgestormbreaker.in
 * forgestormbreaker.out
 *
 * @author Yashas Ravi
 * 
 */
